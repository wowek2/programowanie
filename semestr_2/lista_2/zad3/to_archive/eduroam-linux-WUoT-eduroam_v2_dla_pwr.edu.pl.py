...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "Wroclaw University of Technology"
Config.profilename = "eduroam v2 dla pwr.edu.pl"
Config.url = "https://eduroam.pwr.edu.pl"
Config.email = "eduroam@pwr.edu.pl"
Config.title = "eduroam CAT"
Config.server_match = "rad01.pwr.edu.pl"
...
Config.user_realm = "pwr.edu.pl"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:rad01.pwr.edu.pl']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@pwr.edu.pl"
Config.tou = ""
